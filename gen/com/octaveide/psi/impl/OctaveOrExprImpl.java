...
public class OctaveOrExprImpl extends OctaveExprImpl implements OctaveOrExpr {

  public OctaveOrExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof OctaveVisitor) ((OctaveVisitor)visitor).visitOrExpr(this);
